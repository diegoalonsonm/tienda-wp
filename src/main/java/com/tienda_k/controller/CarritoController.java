...
import com.tienda_k.domain.*;
import com.tienda_k.services.*;
...
public class CarritoController {
    ...
    public String inicio(Model model) {
        ...
        model.addAttribute("totalDolares", (double) (Math.round(carritoTotalVenta / tipoCambio * 100) / 100));
        model.addAttribute("precioVenta", tipoCambio);

...
import com.tienda_k.services.CorreoService;
import com.tienda_k.services.RegistroService;
import com.tienda_k.services.UsuarioService;
...
public class RegistroServiceImpl implements RegistroService {
    ...
    public Model crearUsuario(Model model, Usuario usuario) throws MessagingException {
        ...
        if (!usuarioService.existeUsuarioPorUsernameOCorreo(usuario.getUsername(), usuario.getCorreo())) {
            ...
            mensaje = String.format(messageSource.getMessage("registro.mensaje.activacion.ok", 
                            null, 
                            Locale.getDefault()),
                    usuario.getCorreo());
        } else {
